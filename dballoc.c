...
gint wg_init_db_memsegment(void* db, gint key, gint size) {
  ...
  tmp=init_area_buckets(db,&(dbh->listcell_area_header)); // fill buckets with 0-s
  ...
  tmp=init_area_buckets(db,&(dbh->shortstr_area_header)); // fill buckets with 0-s
  ...
  tmp=init_area_buckets(db,&(dbh->word_area_header)); // fill buckets with 0-s
  ...
  tmp=init_area_buckets(db,&(dbh->doubleword_area_header)); // fill buckets with 0-s
  ...
  tmp=init_area_buckets(db,&(dbh->tnode_area_header)); // fill buckets with 0-s
  ...
  tmp=init_area_buckets(db,&(dbh->indexhdr_area_header)); // fill buckets with 0-s
  ...
  tmp=init_area_buckets(db,&(dbh->indextmpl_area_header)); // fill buckets with 0-s
